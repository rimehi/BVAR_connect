function data = sim_simulation_large_30(seed)
rng(seed)
L = 1;
G = 2;
n = 80;
...
T = 150;
% Create group labels
eta = [ones(1,20),2*ones(1,60)];
% Define underlying structural connectivity
DTI_mat = [];
% Create Structrual Prior
vals = unifrnd(0.3,0.7,15*31,1);
vals(randsample(1:465,400)) = 0.1;
B = zeros(30); % define B of required size
[ii jj] = ndgrid(1:30); % ii and jj are row and column indices respectively
